      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-1 text-sm text-white/85">
              <li><a href="mailto:contact@1expert.fr" className="group flex items-center gap-2 rounded-[3px] px-2 py-1.5 -mx-2 transition-colors hover:bg-[#3E8EF7]/10 hover:text-white"><span className="h-1 w-1 shrink-0 rounded-full opacity-0 transition-opacity group-hover:opacity-100" style={{ backgroundColor: "#3E8EF7" }} />contact@1expert.fr</a></li>
